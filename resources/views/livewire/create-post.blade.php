...
<div>
  <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
      ...
      <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Do you mean <span x-text="$wire.title"></span> </h1>
      ...
      <form wire:submit="saver">
        <div class="grid grid-cols-1 md:px-28 gap-x-8 gap-y-6 sm:grid-cols-2 mt-6">
          ...
          <div class="sm:col-span-2">
            ...
            <div class="mt-2">
              <textarea wire:model="content" class="block w-full h-12 px-4 py-3 bg-gray-100 border-0 border-b border-transparent rounded-md focus:border-green-500 focus:ring-0 sm:text-md" placeholder="enter content"></textarea>
            </div>
            <small>Character:
