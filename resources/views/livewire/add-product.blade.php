    ...
    <div class="max-w-md mx-auto">
        <form wire:submit.prevent="submit" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input wire:model.live="name" type="text" id="name" name="name" placeholder="Product Name"
            ...
            <div class="mb-4">
                ...
                <input wire:model="slug" type="text" disabled value="{{ $slug }}" placeholder="Product Slug"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            ...
            <div class="mb-4">
                ...
                <input wire:model.defer="price" type="number" id="price" name="price" placeholder="Product Price"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            ...
            <div class="mb-4">
                ...
                <input wire:model.defer="width" type="number" id="width" name="width" placeholder="Product Width"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            ...
            <div class="mb-4 flex gap-3 justify-between">
                @if ($photos)
                    @foreach ($photos as $photo)
                        <div class="">
                            <img src="{{ $photo->temporaryUrl() }}" class="rounded-xl w-40 h-40 mb-2" alt="Preview">
                        </div>
                    @endforeach
                @endif
            </div>
